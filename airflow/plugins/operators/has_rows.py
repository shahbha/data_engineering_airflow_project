...
"""
Summary line. 
HasRowsOperator creates a node in the dag 
to count number of rows in the Redshift table
its processing in the SUBDAG and raises 
ERROR when it encounters 0 rows. 
"""
